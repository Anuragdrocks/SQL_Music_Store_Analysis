...
most money. Write a query that returns one city that has the highest sum of invoive totals. Return both the city name
...
/* Q5: Who is the best customer? The customer who has spent the most money will be declared the best customer. Write a 
...
Write a query that returns tha Artist name and total track count of top 10 rock bands? */
...
/* Q7: Return all track names that have a song length longer than the average song length.
...
/* Q9: We want to find out most popular music genre for each country. We determine the most
